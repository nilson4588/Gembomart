...
<body class="theme-color-11">
   ...
   <!-- header start -->
    ...
    <!-- header end -->
     <input type="hidden" value="${imgLocation}" id="imgLocation">
                    ...
                    <div id="sidebar-height" class="sidenav marketplace-sidebar svg-icon-menu">
                        <nav>
                            ...
                            <ul id="sub-menu" class="sm pixelstrap sm-vertical">
                                <li> <a href="#"><img src="resources/images/icon/vegetables/1.jpg"
                                            class="img-fluid me-2" alt="">Veg Menu</a>
                                  <!--  
                                            ...
                                            <div class="row m-0">
                                                ...
                                                <div class="col-xl-4">
                                                    <a href="#" class="mega-menu-banner"><img
                                                            src="resources/images/mega-menu/fashion.jpg" alt=""
                                ...
                                <li> <a href="#"><img src="resources/images/icon/vegetables/2.jpg"
                                            class="img-fluid me-2" alt="">Non-veg Menu</a>
                                   <!-- 
                                    <ul>
                                ...
                                <li> <a href="#"><img src="resources/images/icon/vegetables/3.jpg"
                                            class="img-fluid me-2" alt="">food grains</a>
                                  <!--           
                                    <ul>
                                ...
                                <li> <a href="#"><img src="resources/images/icon/vegetables/4.jpg"
                                            class="img-fluid me-2" alt="">Bakery & dairy</a>
                                   <!--          
                                    <ul>
                                ...
                                <li><a href="#"><img src="resources/images/icon/vegetables/5.jpg" class="img-fluid me-2"
                                            alt="">beverages</a></li>
                                            
                                            
                                <li> <a href="#"><img src="resources/images/icon/vegetables/6.jpg"
                                            class="img-fluid me-2" alt="">Snacks</a>
                                  <!--           
                                    <ul>
                                        <li><a href="#">fashion jewellery</a></li>
                                        <li><a href="#">caps and hats</a></li>
                                ...
                                <!-- <li><a href="#"><img src="resources/images/icon/vegetables/7.jpg" class="img-fluid me-2"
                                            alt="">beauty product</a></li>
                                <li><a href="#"><img src="resources/images/icon/vegetables/8.jpg" class="img-fluid me-2"
                                            alt="">gourment</a></li>
                                <li><a href="#"><img src="resources/images/icon/vegetables/9.jpg" class="img-fluid me-2"
                                            alt="">kitchen, garden</a></li>
                                <li><a href="#"><img src="resources/images/icon/vegetables/9.jpg" class="img-fluid me-2"
                                            alt="">kitchen, garden</a></li> -->
                            </ul>
                        </nav>
                        ...
                        <div class="slider-animate home-slider">
                            <div>
                                <div class="home height-apply">
                                    <img src="resources/images/vegetables/banner/img1.jpg" alt=""
                                                ...
                                                <div class="slider-contain px-padding height-apply">
                                                    <div>
                                                        ...
                                                        <h1 class="animated" data-animation-in="fadeInUp"
                                                            data-delay-in="0.3">vegetables</h1> -->
                                                        <a href="#"
                            ...
                            <div>
                                <div class="home height-apply">
                                    <img src="resources/images/vegetables/banner/img2.jpg" alt=""
                                        class="bg-img blur-up lazyload">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="title-basic">
                        <h2 class="title font-fraunces"><i class="ti-bolt"></i> Restaurants Around You</h2>                        
                    </div>
                    <div class="five-product no-slider row" id="product-5">
            ...
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner">
                            <div class="img-part">
                                <img src="resources/images/vegetables/banner/img3.jpg"
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner">
                            <div class="img-part">
                                <img src="resources/images/vegetables/banner/img4.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner content-bg">
                                <div>
                ...
                <div class="row partition3">
                    <div class="col-md-4">
                        <a href="#">
                            <div class="collection-banner p-right">
                                <div class="img-part">
                                    <img src="resources/images/vegetables/banner/img5.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                    ...
                    <div class="col-md-4">
                        <a href="#">
                            <div class="collection-banner p-right">
                                <div class="img-part">
                                    <img src="resources/images/vegetables/banner/img6.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                                <div class="contain-banner content-bg banner-3">
                                    <div>
                    ...
                    <div class="col-md-4">
                        <a href="#">
                            <div class="collection-banner p-right">
                                <div class="img-part">
                                    <img src="resources/images/vegetables/banner/img7.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                                <div class="contain-banner content-bg banner-3">
                                    <div>
                                        ...
                                        <div class="product-top-filter">
                                            <div class="container-fluid p-0">
                                                <div class="row">
                                                 ...
                                                 <button type="button" class="btn btn-solid" id="setLocation">Set Location</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-12">
                            <div class="quick-view-img"><img src="resources/images/pro3/1.jpg" alt=""
    ...
    $(document).ready(function(){
		...
		$("#setLocation").click(function() {
			  ...
			  var districtCode = $('#district1').val();  
			  var talukaCode = $('#taluka1').val();  
